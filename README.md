...
*   **Related Research:** (Optional: list any research papers or articles that inspired or were used in the project)
    *   [Example Research Paper Title](Link to paper if available)
